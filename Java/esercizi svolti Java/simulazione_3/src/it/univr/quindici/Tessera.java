...
public final class Tessera<T extends Comparable<T>> implements Comparable<Tessera<T>> {
	...
	public int hashCode() {
		return s.hashCode(); // modificate: non deve essere banale
	}

	public String toString() {
		return s.toString(); // modificate (la stampa di una tessera deve essere la stampa del suo valore)
	}
	...
	public int compareTo(Tessera<T> other) {
		return s.compareTo(other.s); // modificate
	}
}