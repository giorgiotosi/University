...
public class ItalianDate extends Date {
	...
	public ItalianDate(int day, int month, int year) {
		super(daysAfterStartOf1900(day,month,year)); 
	}

	private ItalianDate(int daysAfterStartOf1900) {
		super(daysAfterStartOf1900);
	}
	...
	public String toString() {
		...
		result = String.format("%02d/%02d/%d", getDay(), getMonth(), getYear());
	...
	public ItalianDate after(int days) {
		return new ItalianDate(days+ daysAfterStartOf1900(getDay(),getMonth(),getYear())); 
