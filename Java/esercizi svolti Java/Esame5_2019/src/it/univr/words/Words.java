...
public class Words extends ArrayList<String> { 
	...
	public String toString() {
		return String.format("I have extracted a list of %d words", this.size()); 
	}
	...
	public String mostFrequent() {
		...
		Map<String, Integer> occorenze = new TreeMap<>(  );
        for (String word : this) {
        	occorenze.put(word, occorenze.getOrDefault(word, 0) + 1);
        }
		
        return occorenze.entrySet().stream()
