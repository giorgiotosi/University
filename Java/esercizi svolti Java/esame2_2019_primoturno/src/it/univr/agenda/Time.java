...
public abstract class Time implements Comparable<Time> {
	 ...
	 */
	protected int secondsFromStartOfDay;
	...
	public boolean isBeforeOrEqualTo(Time other) {
        return this.secondsFromStartOfDay <= other.secondsFromStartOfDay;
	}
	...
	public boolean equals(Object other) {
		if(other instanceof Time) {
			return secondsFromStartOfDay == ((Time) other).secondsFromStartOfDay;
		}
		else
			return false;
	}
