...
public class Main {
	...
	private Main(String[] names) {
		...
		PunishableSet<String> set1 = new PunishableSet<String>(names); // COMPLETARE
		play("set1", set1);
		...
		// Samatha 7 punti ecc.)
		PunishableSet<String> set2 = new PunishableSet<String>(names, s -> s.length()); // COMPLETARE
		play("set2", set2);

		// crea un PunishableSet contenente names inizializzati a una
		// quantita' di punti pari al proprio numero di vocali (cioè Fausto 3 punti,
		// Giulio 4 punti ecc.)
		PunishableSet<String> set3 = new PunishableSet<String>(names, s -> countVowels(s)); // COMPLETARE
		play("set3", set3);

		// crea un PunishableSet contenente names inizializzati a 2000 punti
		PunishableSet<String> set4 = new PunishableSet<String>(names, s -> 2000); // COMPLETARE
		play("set4", set4);
		...
		PunishableSet<String> set5 = new PunishableSet<String>(names, s -> 600, s -> adding(s), s -> removing(s)); // COMPLETARE
		play("set5", set5);
